    ...
    <div class="py-12 bg-white xl:py-24">
        <div class="mx-auto lg:max-w-max-1549">
            ...
            @if ($vegan_products->have_posts())
                <h4
                    class="w-full pb-12 max-md:pl-8 max-sm:py-12 product-category-title font-edmondsans text-xl-font font-reg420">
                    Vegan</h4>
                <ul
                    class="flex flex-row flex-wrap justify-start gap-4 px-2 products vegan max-mobile:mt-0 lg:gap-6 desktop:px-0 lg:px-4">
